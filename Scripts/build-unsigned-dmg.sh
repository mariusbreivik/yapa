...
PROJECT="$REPO_ROOT/Vault.xcodeproj"
SCHEME="Vault"
CONFIGURATION="Release"
DERIVED_DATA="$REPO_ROOT/build/derived-data"
STAGING_ROOT="$REPO_ROOT/build/dmg-root"
DIST_DIR="$REPO_ROOT/dist"
APP_PATH="$DERIVED_DATA/Build/Products/$CONFIGURATION/Vault.app"
...
DMG_NAME="Vault-${VERSION}-unsigned.dmg"
...
ditto "$APP_PATH" "$STAGING_ROOT/Vault.app"
